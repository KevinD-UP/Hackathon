...
export default function Graph() {
    ...
    if(decade){
        ...
        for(let i =0; i<avgTemperatureData.length;i++){
            //si on est toujours dans la meme decenie
            if(Number(avgTemperatureData[i][1] ) < currentDecade+10 ){
            ...
            //on viens de sauter une décénie
            else if (Number(avgTemperatureData[i][1] ) >= currentDecade+10 || i == avgTemperatureData.length-1){
                ...
                avgTempDecadeData.push([tmpDecadeWithMonth, currentDecade + "-" + (currentDecade + 9)]);
                prcpDecadeData.push([prcpDecadeWithMonth, currentDecade + "-" + (currentDecade+9)]);
